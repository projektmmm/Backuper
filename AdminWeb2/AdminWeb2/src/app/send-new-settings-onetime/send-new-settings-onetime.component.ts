...
@Component({
  selector: 'send-new-settings-onetime',
  templateUrl: './send-new-settings-onetime.component.html',
  styleUrls: ['./send-new-settings-onetime.component.css']
})
export class SendNewSettingsOnetimeComponent implements OnInit {
  ...
  Send(cron, backupType, year,month,day,hour,minute, ftpserveradress, ftpport, ftpusername, ftppassword, sshserveradress, sshport, sshusername, sshpassword) {
    ...
    const data: Settings = {
      ...
      Cron: "#" + year + "-" + month + "-" + day + " " + hour +":" + minute + ":00",
    ...
    if(backupType == "" || this.DestinationPaths.join() == "")
    {
      console.log("xxx");
  ...
  UpdatePlannedBackup(cron, backupType,year,month,day,hour,minute, ftpserveradress, ftpport, ftpusername, ftppassword, sshserveradress, sshport, sshusername, sshpassword) {
    this
